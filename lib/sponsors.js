...
const SPONSORS = [
  ...
  },
  {
    ...
    // banner they serve as og:image. Serve a wzyfa-hosted 630×630 canvas
    // with their wordmark centered on white — same trick as Rezolyzer.
    // Routes the post through wzyfa's OG substitution instead of letting
    // FB scrape finalizat.com directly.
    ogImage: 'https://wzyfa.com/assets/sponsors/finalizat.png',
    positions: [
      'Manager',
      'Graphic Designer',
      'Motion Graphic',
  ...
  },
  {
    ...
    //
    // Serve from wzyfa /assets/sponsors/ — their raw logo is 814×159 which
    // is under FB's 200×200 minimum for large previews and gets rejected
    // in favor of a page-body <img>. The wzyfa-hosted copy is padded to
    // 630×630 on a white canvas so FB accepts it.
    ogImage: 'https://wzyfa.com/assets/sponsors/rezolyzer.png',
    positions: [
      'Frontend Developer',
      'Backend Developer',
      'AI Engineer',
